...
#define SPRITE_MEM_LASER_IDX 3
#define SPRITE_MEM_SHIP_IDX 4
#define SPRITE_MEM_ENERGY_IDX 5
#define SPRITE_MEM_GOLD_IDX 6
#define SPRITE_MEM_SCUBA_IDX 7
#define SPRITE_MEM_WEAPON_IDX 8
#define SPRITE_MEM_BOOTS_IDX 9
#define SPRITE_MEM_EXTRA_LIFE_IDX 10

// Enemy sprites - Load dynamically
#define SPRITE_MEM_SNAKE_IDX 11
#define SPRITE_MEM_BEE_IDX 12
#define SPRITE_MEM_GHOST_IDX 13
#define SPRITE_MEM_SCORPION_IDX 14
#define SPRITE_MEM_WASP_IDX 15
#define SPRITE_MEM_FISH1_IDX 16
#define SPRITE_MEM_BIG_GHOST_IDX 17
...
#define SPRITE_MEM_DRAGONFLY_IDX 27
#define SPRITE_MEM_BIG_BEAR_IDX 28
#define SPRITE_MEM_CLOUDS_IDX 29
#define SPRITE_MEM_FLIES_IDX 30
#define SPRITE_MEM_SHARK_IDX 31
#define SPRITE_MEM_BLUEHAWK_IDX 32
#define SPRITE_MEM_BEETLE_IDX 33
#define SPRITE_MEM_JELLYFISH_IDX 34
#define SPRITE_MEM_WOLF_IDX 35
