...
EnemyStats enemyStats[25] = {
    ...
    { SPRITE_MEM_GHOST_IDX,     20, 3,  6,  180, 0,   1 },
    { SPRITE_MEM_SCORPION_IDX,  6,  6,  4,  90,  240, 0 },
    { SPRITE_MEM_WASP_IDX,      6,  12, 3,  120, 0,   1 },
    { SPRITE_MEM_FISH1_IDX,     30, 4,  2,  120, 105, 1 },
    { SPRITE_MEM_BIG_GHOST_IDX, 8,  3,  10, 120, 0,   1 },
    { SPRITE_MEM_EYEBALL_IDX,   6,  6,  4,  90,  0,   1 },
    { SPRITE_MEM_MUSHROOM_IDX,  30, 4,  4,  90,  0,   1 },
    { SPRITE_MEM_SLIME_IDX,     20, 4,  4,  90,  300, 1 },
    { SPRITE_MEM_SPIDER_IDX,    6,  9,  3,  90,  120, 0 },
    { SPRITE_MEM_RAT_IDX,       6,  10, 3,  90,  180, 0 },
    { SPRITE_MEM_ROCKMAN_IDX,   10, 2,  5,  90,  0,   1 },
    { SPRITE_MEM_EEL_IDX,       6,  10, 1,  90,  90,  1 },
    { SPRITE_MEM_ICEMAN_IDX,    12, 2,  4,  90,  0,   1 },
    { SPRITE_MEM_SNOWBALL_IDX,  6,  8,  3,  90,  120, 1 },
    { SPRITE_MEM_DRAGONFLY_IDX, 6,  11, 3,  80,  180, 1 },
    { SPRITE_MEM_BIG_BEAR_IDX,  6,  10, 10, 120, 180, 1 },
    { SPRITE_MEM_CLOUDS_IDX,    6,  6,  3,  90,  0,   1 },
    { SPRITE_MEM_FLIES_IDX,     4,  10, 10, 120, 180, 1 },
    { SPRITE_MEM_SHARK_IDX,     20, 7,  5, 120, 120, 1 },
    { SPRITE_MEM_BLUEHAWK_IDX,  6,  11, 2,  80,  180, 1 },
    { SPRITE_MEM_BEETLE_IDX,    12, 4,  2,  90,  0,   1 },
    { SPRITE_MEM_JELLYFISH_IDX, 8,  3,  2,  120, 360, 1 },
    { SPRITE_MEM_WOLF_IDX,      6,  6,  4,  90,  240, 1 },
};
