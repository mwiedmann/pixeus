...
EnemyStats enemyStats[25] = {
    ...
    { SPRITE_MEM_SNAKE_IDX,     6,  8,  3,  120, 300, 0 },
    { SPRITE_MEM_BEE_IDX,       6,  13, 2,  100, 0,   1 },
    { SPRITE_MEM_GHOST_IDX,     20, 3,  5,  180, 0,   1 },
    { SPRITE_MEM_SCORPION_IDX,  6,  6,  3,  120, 240, 0 },
    { SPRITE_MEM_WASP_IDX,      6,  12, 2,  150, 0,   1 },
    { SPRITE_MEM_FISH1_IDX,     30, 4,  2,  150, 105, 1 },
    { SPRITE_MEM_BIG_GHOST_IDX, 8,  3,  7,  150, 0,   1 },
    { SPRITE_MEM_EYEBALL_IDX,   6,  6,  3,  120, 0,   1 },
    { SPRITE_MEM_MUSHROOM_IDX,  30, 4,  3,  120, 0,   1 },
    { SPRITE_MEM_SLIME_IDX,     20, 4,  3,  150, 300, 1 },
    { SPRITE_MEM_SPIDER_IDX,    6,  9,  2,  120, 120, 0 },
    { SPRITE_MEM_RAT_IDX,       6,  10, 2,  120, 180, 0 },
    { SPRITE_MEM_ROCKMAN_IDX,   10, 2,  4,  120, 0,   1 },
    { SPRITE_MEM_EEL_IDX,       6,  10, 1,  120, 90,  1 },
    { SPRITE_MEM_ICEMAN_IDX,    12, 2,  3,  120, 0,   1 },
    { SPRITE_MEM_SNOWBALL_IDX,  6,  8,  3,  120, 120, 1 },
    { SPRITE_MEM_DRAGONFLY_IDX, 6,  11, 2,  120, 180, 1 },
    { SPRITE_MEM_BIG_BEAR_IDX,  6,  10, 7,  150, 180, 1 },
    { SPRITE_MEM_CLOUDS_IDX,    6,  6,  3,  120, 0,   1 },
    { SPRITE_MEM_FLIES_IDX,     4,  10, 7,  150, 180, 1 },
    { SPRITE_MEM_SHARK_IDX,     20, 7,  4,  150, 120, 1 },
    { SPRITE_MEM_BLUEHAWK_IDX,  6,  11, 2,  120, 180, 1 },
    { SPRITE_MEM_BEETLE_IDX,    12, 4,  2,  120, 0,   1 },
    { SPRITE_MEM_JELLYFISH_IDX, 8,  3,  2,  150, 360, 1 },
